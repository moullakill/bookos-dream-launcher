...
import { SystemStatusView } from '@/components/bookos/SystemStatusView';
...
type ViewType = 'home' | 'library' | 'settings' | 'developer' | 'status';
  ...
  return (
    <div className={cn('min-h-screen flex flex-col bg-background', themeClass)}>
      ...
      <div className="relative flex flex-col h-screen z-10">
        ...
        <Dock
          activeView={activeView === 'developer' ? 'settings' : activeView === 'status' ? 'status' : activeView}
